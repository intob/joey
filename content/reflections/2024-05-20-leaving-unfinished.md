...
This led me to reflect on my own habbit of doing the same. I see merit in occasionally parking ideas indeffinitely. That is, if the real goal of any personal project is not to output a peice of work, but to learn skills necessary for a future project, it follows that we must let it go once we see a bridge to the next phase of learning.
